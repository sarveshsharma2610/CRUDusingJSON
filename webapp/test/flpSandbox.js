		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#crudusingjson-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"crudusingjson-display": {
								"semanticObject": "crudusingjson",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=crudusingjson",
									"url": sap.ui.require.toUrl("crudusingjson")
								}
							}
						}
					}
